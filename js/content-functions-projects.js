/*function projects_introduction(){
    ...
    +"- <a href='https://www.starengtech.com/timing-control'>https://www.starengtech.com/timing-control</a><br>"
    +"<p><button style=background-color:#257886;border-radius:16px;border-color:#103d46;color:white; onclick=projects_timing_control()>more info...</button></p><br>"
    ...
    +"<p><button style=background-color:#257886;border-radius:16px;border-color:#103d46;color:white; onclick=projects_asm_manager()>more info...</button></p><br>"
    ...
    +"<p><button style=background-color:#257886;border-radius:16px;border-color:#103d46;color:white; onclick=projects_ola_task()>more info...</button></p><br>"
...
function projects_timing_control(){
    document.getElementById("title").innerHTML = "Timing control"; 
    document.getElementById("text1").innerHTML = 
...
function projects_asm_manager(){
    document.getElementById("title").innerHTML = "ASM Manager"; 
    document.getElementById("text1").innerHTML = 
    "<b>Timing control</b>: Stareng Technology<br>"
...
function projects_ola_task(){
    document.getElementById("title").innerHTML = "Ola Task"; 
    document.getElementById("text1").innerHTML = 
    "<b>Timing control</b>: Stareng Technology<br>"
    +"Development: 2022<br><br>"
...
function projects_ubm_stareng(){
    document.getElementById("title").innerHTML = "UBM Stareng"; 
    document.getElementById("text1").innerHTML = 
    "<b>Timing control</b>: Stareng Technology<br>"
    +"Development: 2022<br><br>"
